...
class OmniVoiceSampleProcessor:
    ...
    def __init__(
        ...
        # When True, only cb0 receives random masking in the target region;
        # cb1..num_channels-1 are always masked. This matches the Cascaded
        # Predictor inference pathway where Predictor fills cb1..15 after
        # cb0 is generated by the backbone.
    ...
    def __call__(self, sample: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.predictor_mode:
            # Force cb1..C-1 fully masked in the target region (Predictor handles them).
            token_mask[1:, :] = True
